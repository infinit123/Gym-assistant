/**
 * Main Application Controller & Router (Verified Safe Navigation)
 */
const App = {
  init() {
      ...
      <div class="modal-overlay motion-fade-in">
        <div class="modal-card">
          ...
          <div class="modal-actions">
            ...
            <button id="btn-confirm-reset" class="btn-primary" style="background: #ef4444; color: #fff;">RESTART</button>
          </div>
        </div>
      </div>
    `;
